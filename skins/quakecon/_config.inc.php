...
$colors['background'] = '#313163';
$colors['primary'] = '#ffffff'; //'#E8860C';
$colors['secondary'] = '#bbbbbb'; //'#804F01';
$colors['border'] = '#4a4e6b'; //'#4C4D5C';
$colors['border_alternate'] = '#181821'; // currently only used on bargraph borders
$colors['cell_title'] = '#4a4e6b'; //'#595B68';
$colors['cell_background'] = '#313163';
$colors['cell_alternate'] = '#30325C';
$colors['text'] = '#9999AC';
$colors['blended_text'] = '#ADAAAD';
