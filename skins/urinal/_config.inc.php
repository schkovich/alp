...
$colors["background"] = "#ffcc00";
$colors["primary"] = "#A47F00";
$colors["secondary"] = "#804F01";
$colors["border"] = "#000000";
$colors["border_alternate"] = "#6C5400"; // currently only used on bargraph borders
$colors["cell_title"] = "#EAB600";
$colors["cell_background"] = "#ffcc00";
$colors["cell_alternate"] = "#eebb00";
$colors["text"] = "#000000";
$colors["blended_text"] = "#6C5400";
$colors["graphs"] = $colors["primary"];
$colors['alert'] = '#ff0000';

$colors["image_text"] = "black"; // ONLY white or black
