...
$colors['primary'] = '#ffffff'; //'#E8860C';
$colors['secondary'] = '#848548'; //'#804F01';
$colors['border'] = '#343C1C'; //'#4C4D5C';
$colors['border_alternate'] = '#343C1C'; // currently only used on bargraph borders
$colors['cell_title'] = '#000000'; //'#B5B655';
$colors['cell_background'] = '#000000';
$colors['cell_alternate'] = '#1C2414';
$colors['text'] = '#F9FA92';
$colors['blended_text'] = '#fcfcd8';
